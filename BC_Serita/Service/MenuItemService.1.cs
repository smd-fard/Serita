...
{
    public class MenuItemService2 : IMenuItemService2
    {
        /*
        ...
        public bool InsertAfter(MenuItemDto entity, MenuItemDto after)
        {
        ...
        public bool Delete(MenuItemDto entity)
        {
        ...
        public bool DeleteChildren(MenuItemDto entity)
        {
        ...
        public IEnumerable<MenuItemDto> GetChildren(MenuItemDto entity)
        {
            return this.GetChildren(entity.Id);
        }

        public bool ChangeParent(MenuItemDto entity, int newParentId)
        {
        ...
        public bool MoveUp(MenuItemDto entity)
        {
        ...
        public bool MoveDown(MenuItemDto entity)
        {
