...
{
    public class MenuItemBL2 : IMenuItemBL2
    {
        /*
        ...
        public bool Insert(MenuItemDto entity)
        {
            TrimTitle(entity);
            ...
            var val = _valueRep.Find(menu.Id);
            if (val == null)
            {
                var value = MenuItemValue.Create(menu);
                _valueRep.Insert(value);
            }

            var title = MenuItemTitle.Create(menu);
            _titleRep.Insert(title);

            return true;
        }

        private bool InsertValidation(MenuItemDto entity)
        {
            bool result = true;
        ...
        public bool Update(MenuItemDto entity)
        {
            TrimTitle(entity);
        ...
        private bool UpdateValidation(MenuItemDto entity)
        {
            bool result = true;
        ...
        public MenuItemDto Find(int id)
        {
        ...
        public IEnumerable<MenuItemDto> GetMainMenuItems()
        {
        ...
        public IEnumerable<MenuItemDto> GetChildren(int id)
        {
        ...
        private void TrimTitle(MenuItemDto entity)
        {
        ...
        public MenuItemDto GetNextSibling(MenuItemDto entity)
        {
        ...
        public IEnumerable<MenuItemDto> GetNextSiblings(MenuItemDto entity)
        {
        ...
        public MenuItemDto GetPreviousSibling(MenuItemDto entity)
        {
            var menu = _menuRep.GetSingle(where: x => x.LanguageId == _sessionProvider.LanguageId && x.ParentId == entity.ParentId && x.Ordering < entity.Ordering, orderBy: x => x.Ordering);
        ...
        public IEnumerable<MenuItemDto> GetPreviousSiblings(MenuItemDto entity)
        {
            var menus = _menuRep.Get(where: x => x.LanguageId == _sessionProvider.LanguageId && x.ParentId == entity.ParentId && x.Ordering < entity.Ordering, orderBy: x => x.Ordering);
